...
def load_data(uploaded_file):
    ...
    # Fill missing 'dest_scheduled_time' based on 'origin_arrival_time'
    ...
    # Classify 'miles_prime' into high and low for color coding
...
if uploaded_file is not None:
    ...
    if not filtered_data.empty:
        ...
        # Display driving duration distribution chart
